 ...
 * limitations __restrict__ what can be done within an OpenACC parallel region,
...
ApplyFloatStencil( void* vdata,
                    ...
                    void* cbData )
{
    float* __restrict__ data = (float*)vdata;
     ...
     */
    float* __restrict__ other = (float*)calloc( nRows * nPaddedCols, sizeof(float) );
