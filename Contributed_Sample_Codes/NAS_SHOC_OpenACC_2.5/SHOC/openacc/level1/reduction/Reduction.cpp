...
VerifyResult(T devResult, T* idata, const unsigned int nItems)
{
    ...
    std::cout << "exp: " << refResult << ", res: " << devResult << std::endl;
    double err;
    if( refResult != 0.0 )
    {
...
//
// ****************************************************************************
void DoReduceDoublesIters( unsigned int nIters,
                                        void* idata, 
                                        unsigned int nItems, 
                                        void* ores,
...
void DoReduceFloatsIters( unsigned int nIters,
                                        void* idata, 
                                        unsigned int nItems, 
                                        void* ores,
                                        double* itersReduceTime,
                ...
                OptionParser& opts)
{
    ...
    // Initialize input
    std::cout << "Initializing input." << "nItems: " << nItems << std::endl;
    ...
    for( int pass = 0; pass < nPasses; pass++ )
    {
        ...
        std::cout << "Execution time " << totalReduceTime << std::endl;
        // record results
